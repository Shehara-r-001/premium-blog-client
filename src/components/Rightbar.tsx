...
const Rightbar = ({ access }: Props) => {
  ...
  return (
    <div className='border border-[#008ae6] w-4/5 mx-auto md:w-1/4 md:h-[100px] p-3 md:flex items-start justify-center flex-col rounded-lg md:fixed md:top-20 md:right-5 hidden'>
